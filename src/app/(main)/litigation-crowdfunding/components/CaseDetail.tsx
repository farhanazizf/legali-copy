...
export default function CaseDetail({
  ...
  const handleInvestment = () => {
    if (
      !investmentAmount ||
      parseFloat(investmentAmount) < caseData.minimumInvestment
    ) {
      toast({
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <Badge
                              className={riskLevels[caseData.riskLevel].color}
                            >
                              {caseData.riskLevel}
                            </Badge>
                          </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="space-y-1 text-sm">
                            <div>
                              <span className="font-medium">Lead Counsel:</span>{" "}
                              {caseData.leadCounsel}
                            </div>
                            <div>
                              <span className="font-medium">Experience:</span>{" "}
                              {caseData.counselExperience}
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        All legal teams on Legali are vetted for experience,
                        track record, and good standing with their respective
                        bar associations.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
                  ...
                  <CardContent className="space-y-6">
                    <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                      ...
                      <p className="text-sm text-yellow-700">
                        This case has been assessed as having{" "}
                        {caseData.riskLevel.toLowerCase()} risk based on various
                        factors including legal precedents, evidence strength,
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        <strong>Investment Risk:</strong> All litigation
                        investments carry inherent risks. Past performance does
                        not guarantee future results. Please read all disclosure
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {!showInvestmentForm ? (
                  <Button
                    ...
                    onClick={() => onInvestmentStart(caseData)}
                  >
            ...
            <Alert>
              <AlertTriangle className="h-4 w-4" />
              <AlertDescription>
                <strong>Important:</strong> This is a speculative investment
                with inherent risks. Please read all disclosures before
                investing.
              </AlertDescription>
            </Alert>
          </div>
