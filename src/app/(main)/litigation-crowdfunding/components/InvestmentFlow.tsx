...
export default function InvestmentFlow({ case: caseData, onBack, onComplete }: InvestmentFlowProps) {
  ...
  const handleNext = () => {
    if (currentStep === 1) {
      if (!investmentData.amount || parseFloat(investmentData.amount) < caseData.minimumInvestment) {
        toast({
    ...
    if (currentStep === 2) {
      if (!investmentData.disclosureAcknowledged || !investmentData.riskAcknowledged || !investmentData.kycConfirmed) {
        toast({
          title: "Required Acknowledgments",
          description: "Please review and acknowledge all required disclosures.",
          variant: "destructive",
        });
        return;
      }
        ...
        <div className="mx-auto max-w-4xl">
                ...
                <div key={step.number} className="flex-1">
                  <div className="flex items-center">
                    ...
                    {index < steps.length - 1 && (
                      <div
                        className={`mx-4 h-0.5 flex-1 ${currentStep > step.number ? "bg-blue-600" : "bg-gray-300"}`}
                      />
                    )}
                  </div>
            ...
            <CardContent>
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e => updateInvestmentData({ amount: e.target.value })}
                        className="text-lg"
                      />
                      <p className="mt-1 text-sm text-gray-500">
                        Minimum investment: {formatCurrency(caseData.minimumInvestment)}
                      </p>
                    </div>
                    <div>
                      ...
                      <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                        <div className="text-lg font-semibold text-green-800">
                          {investmentData.amount
                            ? calculateExpectedReturn(parseFloat(investmentData.amount) || 0)
                        ...
                        <div className="text-sm text-green-600">Based on {caseData.expectedReturn} multiplier</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Your investment will be held in a secure escrow account until the funding goal is met.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                    <h3 className="mb-2 font-semibold text-blue-900">Investment Summary</h3>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-blue-900">
                          {calculateExpectedReturn(parseFloat(investmentData.amount))}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <label htmlFor="disclosure" className="text-sm leading-relaxed">
                        ...
                        and acknowledge that I have reviewed all case details, financial projections, and legal
                        analysis.
                      </label>
                    </div>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Legal Notice:</strong> By proceeding, you acknowledge that you have received and reviewed
                      all required disclosures for this investment opportunity.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
                  ...
                  <div className="rounded-lg border bg-gray-50 p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{formatCurrency(parseFloat(investmentData.amount))}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Platform Fee (2.5%):</span>
                        <span className="font-medium">{formatCurrency(parseFloat(investmentData.amount) * 0.025)}</span>
                      </div>
                      <div className="flex justify-between border-t pt-2 font-semibold">
                        <span>Total Amount:</span>
                        <span>{formatCurrency(parseFloat(investmentData.amount) * 1.025)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                      ...
                      <p className="text-sm text-green-700">
                        Your payment is processed securely and held in escrow until the case funding goal is met.
                      </p>
                    </div>
              ...
              {currentStep === 4 && (
                <div className="space-y-6 text-center">
                  ...
                  <div>
                    <h2 className="mb-2 text-2xl font-bold text-gray-900">Investment Successful!</h2>
                    <p className="text-gray-600">
                      Your investment of {formatCurrency(parseFloat(investmentData.amount))} has been processed
                      successfully.
                    </p>
                  </div>
                  ...
                  <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-left">
                    ...
                    <ul className="space-y-1 text-sm text-blue-800">
                      ...
                      <li>• You'll receive regular updates on the case progress</li>
                      <li>• Returns will be distributed if the case is successful</li>
                    </ul>
                  </div>
          ...
          {currentStep < 4 && (
            <div className="mt-6 flex items-center justify-between">
              ...
              <Button onClick={handleNext} disabled={isProcessing} className="bg-blue-600 hover:bg-blue-700">
                {currentStep === 3 ? (
                  isProcessing ? (
                    "Processing..."
                  ) : (
